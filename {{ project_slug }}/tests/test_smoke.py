...
import pytest
from {{ package_slug }}.core import SystemConfig, AgentStatus
from {{ package_slug }}.agents.protocols import MessageType, AgentMessage
from {{ package_slug }}.utils.validation import validate_agent_message, validate_agent_config
...
class TestSmokeTests:
    ...
    def test_import_package(self) -> None:
        ...
        import {{ package_slug }}
        assert hasattr({{ package_slug }}, "__version__")
        assert hasattr({{ package_slug }}, "__author__")
        assert hasattr({{ package_slug }}, "__email__")
    
    def test_import_core_modules(self) -> None:
        """Test that core modules can be imported."""
        from {{ package_slug }}.core import BaseAgent, AgentStatus, AgentConfig
        from {{ package_slug }}.agents.protocols import AgentProtocol, MessageType
        from {{ package_slug }}.utils import load_config, setup_logging
